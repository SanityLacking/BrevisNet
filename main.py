...
if __name__ == "__main__":
    ...
    x = branching.core.Run_alexNet( 30, modelName="alexNetv6.hdf5", saveName = "alexNetv6_vanilla_T_2",transfer = True,customOptions="CrossE")
    
    # x = branching.models.SelfDistilation.alexnet( 30, modelName="alexNetv6.hdf5", saveName = "alexNetv6_feat_distill_3",transfer = True,customOptions="CrossE")
